...
public class musclebuilding extends AppCompatActivity {
    Button home, weightloss, weightgain;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_musclebuilding);
        ...
        home.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(musclebuilding.this, MainActivity.class));
            }
        }));
        weightloss.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(musclebuilding.this, weightloss.class));
            }
        }));
        weightgain.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(musclebuilding.this, weightgain.class));
            }
        }));
    }
}